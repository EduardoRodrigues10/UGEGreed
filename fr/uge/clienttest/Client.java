...
public class Client {
    ...
    /**
     * This method downloads the jar file from the given url and creates an instance
     * of the class assuming it implements the fr.uge.ugegreed.Checker interface.
     *
     * This method can both be used retrieve the class from a local jar file or from
     * a jar file provided by an HTTP server. The behavior depends on the url
     * parameter.
     *
    ...
    public static Optional<Checker> retrieveCheckerFromURL(URL url, String className) {
        ...
        try {
            ...
            logger.info("The class %s was not found in %s. The jarfile might not be present at the given URL."
                    .formatted(className, url));
    ...
    public static void main(String[] args) throws InterruptedException {
        var checker = checkerFromHTTP("http://www-igm.univ-mlv.fr/~carayol/Factorizer.jar", "fr.uge.factors.Factorizer")
                .orElseThrow();
        System.out.println(checker.check(12L));
        checker = checkerFromDisk(Path.of("/Users/carayol/bb/progreseau/jars/Collatz.jar"), "fr.uge.collatz.Collatz")
                .orElseThrow();
        System.out.println(checker.check(12L));
        checker = checkerFromHTTP("http://www-igm.univ-mlv.fr/~carayol/SlowChecker.jar", "fr.uge.slow.SlowChecker")
                .orElseThrow();
        System.out.println(checker.check(12L));
    }
}